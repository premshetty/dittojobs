...
function Table() {
  ...
  return (
    <div>
      <div className="px-5 mb-3 md:px-0 gap-4 md:p-3 flex justify-between h-[67px] py-[10px] bg-white max-w-7xl m-auto">
        <div className=" flex h-[47px] w-[222px] items-center  border-[1px] border-[#CECFD1] ">
          <input
            type="text"
            className="ml-2 w-full   p-[12px]  bg-transparent placeholder-[#C5C0C0] outline-none"
            placeholder="Search "
            onChange={(e) => {
        ...
        <div className="flex items-center">
          ...
          <input
            ...
            className="md:ml-2 h-5 w-5 accent-[#d9eef8] "
          />
        </div>
      </div>
      <div className="h-[100vh] w-full bg-[#eef3f6] overflow-x-scroll">
        <div className="max-w-7xl m-auto ">
          <h1 className="text-end text-[#7c7c80]  py-3">6interview request</h1>
          <table
            style={{ boxShadow: "1px 1px 5px rgba(0 0 0 / 0.1)" }}
            className="min-w-full bg-white  leading-normal  h-full"
          >
            <TableHeader
